...
# Accepts either "Minutes" or "Min" from ETR.
...
def _norm_df(df: pd.DataFrame) -> pd.DataFrame:
    # Flexible minutes: accept Minutes OR Min
    minutes_col = _resolve_col(df, "Minutes", ["Min", "mins", "MINS"])
    req_map = {
        ...
        "3PM":    _resolve_col(df, "3PM",  ["3pt", "3p", "threes", "three_pointers_made"]),
